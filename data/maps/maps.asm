...
MapGroup_Azalea:
	...
	map AlderTown, TILESET_JOHTO, TOWN, ALDER_TOWN, MUSIC_MOBILE_ADAPTER_MENU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodHappinessRater, TILESET_HOUSE, INDOOR, CHERRYGROVE_WOODS, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
