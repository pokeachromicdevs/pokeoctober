...
MapGroup_Azalea:
	...
	map AlderMart, TILESET_MART, INDOOR, ALDER_TOWN, MUSIC_ALDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Citrine:
	...
	map CitrineMart, TILESET_CAPUMON_MART, INDOOR, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
