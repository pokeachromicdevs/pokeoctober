...
MapGroup_Goldenrod:
	...
	map GoldenrodHappinessRater, TILESET_HOUSE, INDOOR, ALDER_TOWN, MUSIC_ALDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodNameRater, TILESET_HOUSE, INDOOR, CHERRYGROVE_WOODS, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
