...
MapGroup_Shrine:
	map CherrygroveShrine, TILESET_PARK, ROUTE, SAKURA_SHRINE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CherrygroveShrineGate, TILESET_GATE, GATE, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
