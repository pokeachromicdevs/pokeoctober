...
MapGroup_Violet:
	...
	map DreadWoods, TILESET_JOHTO, CAVE, DREAD_WOODS, MUSIC_DREAD_WOODS, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Cherrygrove:
	...
	map VioletKylesHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
