...
MapGroup_Olivine:
	...
	map OlivineMart, TILESET_MART, INDOOR, OLIVINE_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map SproutTower4F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower5F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower6F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower7F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower8F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower9F, TILESET_TOWER, DUNGEON, SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MahoganyMart1F, TILESET_TRADITIONAL_HOUSE, INDOOR, MAHOGANY_TOWN, MUSIC_POKEMART, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map DiglettsCave, TILESET_CAVE, CAVE, DIGLETTS_CAVE, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakMart, TILESET_MART, INDOOR, ECRUTEAK_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map BlackthornMart, TILESET_MART, INDOOR, BLACKTHORN_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route46, TILESET_SNOW, ROUTE, ROUTE_46, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanMart, TILESET_MART, INDOOR, CERULEAN_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route24, TILESET_KANTO, ROUTE, ROUTE_24, MUSIC_ROUTE_24, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, ROUTE_25, MUSIC_ROUTE_24, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Azalea:
	...
	map AzaleaMart, TILESET_MART, INDOOR, AZALEA_TOWN, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map KurtsHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AlderGym, TILESET_ELITE_FOUR_ROOM, INDOOR, ALDER_TOWN, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route33, TILESET_JOHTO, ROUTE, ROUTE_33, MUSIC_ROUTE_32, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AzaleaTown, TILESET_JOHTO, TOWN, AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AlderPokecenter1F, TILESET_POKECENTER, INDOOR, ALDER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AlderMart, TILESET_MART, INDOOR, ALDER_TOWN, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AlderHappinessRater, TILESET_HOUSE, INDOOR, ALDER_TOWN, MUSIC_ALDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route33EastGate, TILESET_GATE, GATE, ROUTE_33, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route33WestGate, TILESET_GATE, GATE, ROUTE_33, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaGym, TILESET_TOWER, INDOOR, AZALEA_TOWN, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route34, TILESET_JOHTO, ROUTE, ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AzaleaLeftHouse, TILESET_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaRightHouse, TILESET_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	map Route32North, TILESET_JOHTO, ROUTE, ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map Route32South, TILESET_JOHTO, ROUTE, ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	...
	map VioletMart, TILESET_MART, INDOOR, VIOLET_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilentHillsExitGate, TILESET_GATE, GATE, ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route36Gate, TILESET_GATE, GATE, ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map DreadWoods, TILESET_JOHTO, ROUTE, DREAD_WOODS, MUSIC_DREAD_WOODS, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ZenGarden, TILESET_JOHTO, TOWN, ZEN_GARDEN, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VioletHerbShop, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ZenGardenGate, TILESET_GATE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AlderTown, TILESET_JOHTO, TOWN, ALDER_TOWN, MUSIC_ALDER_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VioletHerbShopBasement, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SakuraShrine, TILESET_BETA_TOWER, INDOOR, ZEN_GARDEN, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletMuseum, TILESET_GATE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletFishingGuild, TILESET_HOUSE, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, GOLDENROD_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodR34Gate, TILESET_GATE, GATE, ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionMart, TILESET_MART, INDOOR, VERMILION_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_MART, INDOOR, PEWTER_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map HallOfFame, TILESET_ICE_PATH, INDOOR, INDIGO_PLATEAU, MUSIC_SILENT_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaMart, TILESET_MART, INDOOR, FUCHSIA_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderMart, TILESET_MART, INDOOR, LAVENDER_TOWN, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonDeptStore1F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, CELADON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianMart, TILESET_MART, INDOOR, VIRIDIAN_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silent:
	...
	map SilentTown, TILESET_JOHTO, TOWN, SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ElmsLab, TILESET_LAB, INDOOR, SILENT_TOWN, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersNeighborsHouse, TILESET_HOUSE, INDOOR, SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ElmsHouse, TILESET_PLAYERS_HOUSE, INDOOR, SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map FightingDojo, TILESET_TRAIN_STATION, INDOOR, CHERRYGROVE_CITY, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_MART, INDOOR, SAFFRON_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveMart, TILESET_MART, INDOOR, CHERRYGROVE_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CherrygroveGym, TILESET_ELITE_FOUR_ROOM, INDOOR, CHERRYGROVE_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SilentHillsGate, TILESET_GATE, GATE, ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilentHills, TILESET_JOHTO, ROUTE, SILENT_HILLS, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route29Route46Gate, TILESET_GATE, GATE, ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilentPokecenter1F, TILESET_POKECENTER, INDOOR, SILENT_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilentHillsNameRater, TILESET_HOUSE, INDOOR, SILENT_HILLS, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePagoda1F, TILESET_BETA_TOWER, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePagoda2F, TILESET_BETA_TOWER, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePagoda3F, TILESET_BETA_TOWER, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePagoda4F, TILESET_BETA_TOWER, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePagoda5F, TILESET_BETA_TOWER, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletKylesHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HillsGustHouse, TILESET_HOUSE, INDOOR, SILENT_HILLS, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Citrine:
	map CitrineIsland, TILESET_CAPUMON_OVERWORLD, TOWN, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CitrineMart, TILESET_CAPUMON_MART, INDOOR, CITRINE_ISLAND, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrineInn1F, TILESET_CAPUMON_INN, INDOOR, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrineInn2F, TILESET_CAPUMON_INN, INDOOR, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrineDevHouse1F, TILESET_CAPUMON_HOUSE, INDOOR, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CitrineDevHouse2F, TILESET_CAPUMON_HOUSE, INDOOR, CITRINE_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
