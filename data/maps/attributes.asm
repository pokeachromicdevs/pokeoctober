...
ENDM
	...
	map_attributes SilentTown, SILENT_TOWN, $35, WEST | EAST
	connection west, Route29, ROUTE_29, 1
	connection east, Route27, ROUTE_27, 1
	...
	connection west, SilentTown, SILENT_TOWN, -1
	...
	map_attributes CherrygroveGym, CHERRYGROVE_GYM, $00, 0
	...
	map_attributes Route36Gate, ROUTE_36_GATE, $00, 0
	...
	map_attributes AlderHappinessRater, ALDER_HAPPINESS_RATER, $00, 0
	...
	map_attributes SaffronMagnetTrainStation, ECRUTEAK_MAGNET_TRAIN_STATION, $00, 0
