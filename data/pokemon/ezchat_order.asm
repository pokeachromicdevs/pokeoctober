...
.ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, VULPIX, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MIMENTOR, TYROGUE, CLOYSTER, TYRANITAR, -1
