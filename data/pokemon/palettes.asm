...
INCBIN "gfx/pokemon/vulpvi/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/vulpvi/shiny.pal"
...
INCBIN "gfx/pokemon/mimentor/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/mimentor/shiny.pal"
