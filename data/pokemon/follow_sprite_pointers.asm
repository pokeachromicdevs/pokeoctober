...
;Johto Icons
	...
	follow_sprite SentretSpriteGFX, PAL_FOLLOWER_BROWN ;SENTRET
	...
	follow_sprite WailmerSpriteGFX, PAL_FOLLOWER_BLUE ;WAILMER
	follow_sprite WailordSpriteGFX, PAL_FOLLOWER_BLUE ;WAILORD
	...
	follow_sprite WooperSpriteGFX, PAL_FOLLOWER_BLUE ;VALHALDRA
