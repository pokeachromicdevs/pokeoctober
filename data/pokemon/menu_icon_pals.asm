...
MonMenuIconPals:
	...
	icon_pals BROWN, RED       ; COINPUR
	icon_pals GRAY, BROWN      ; ADBARSTORK
	icon_pals RED, YELLOW      ; PUPPERON
	icon_pals BROWN, RED       ; MOIBELLE
	icon_pals BROWN, BLUE      ; BELLEDAM
	icon_pals BROWN, YELLOW    ; CLEFLING
