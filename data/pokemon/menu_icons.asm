...
MonMenuIcons:
	...
	db ICON_CYNDAQUIL   ; CUBBURN
	db ICON_CYNDAQUIL   ; FLAMBEAR
	db ICON_CYNDAQUIL   ; BRUINUS
	db ICON_TOTODILE    ; PALSSIO
	db ICON_CROCONAW    ; PRESSIO
	db ICON_FERALIGATR  ; DONMARIN
	...
	db ICON_MAREEP		; TYKER
	db ICON_FLAAFFY		; STRAIGAR
	db ICON_AMPHAROS	; GOROTORA
	db ICON_MAGIKARP    ; MOLAMBINO
	db ICON_MAGIKARP    ; CORASUN
	db ICON_MAGIKARP    ; MAMBOKING
	db ICON_GYARADOS    ; ANGORE 
	db ICON_EKANS       ; BITEEL
	db ICON_LANTURN     ; LURREEL
	db ICON_BELLOSSOM   ; BELLOSSOM
	db ICON_MARILL      ; MARILL
	db ICON_AZUMARILL   ; AZUMARILL
	db ICON_CHINCHOU    ; WAILMER
	db ICON_LANTURN     ; WAILORD
	db ICON_MISDREAVUS  ; PHANDARIN
	db ICON_GENGAR      ; KUDATSUBE
	...
	db ICON_DRATINI     ; KUKUULCAN
	db ICON_SKARMORY    ; AIRMOR
	db ICON_SKARMORY    ; AERCROW
	db ICON_SKARMORY    ; ADBARSTORK
	db ICON_HOUNDOUR    ; HOUNDOUR
	db ICON_HOUNDOOM    ; HOUNDOOM
	db ICON_HOUNDOOM    ; GARGRANITE
	db ICON_VULPIX      ; FENNECURSE
	db ICON_GENGAR      ; STROMEN
	db ICON_KINGDRA     ; KINGDRA
	db ICON_KINGDRA     ; ALUMAIDEN
	db ICON_KINGDRA     ; VALHALDRA
	db ICON_KINGLER     ; MAGSTACEAN
	db ICON_PHANPY      ; PHANPY
	db ICON_DONPHAN     ; DONPHAN
	db ICON_LICKITUNG   ; LICKILICKY
	db ICON_PORYGON     ; PORYGIN
	db ICON_PORYGON2    ; PORYGON2
	db ICON_BULBASAUR   ; NORSPRUCE
	...
	db ICON_LUGIA       ; LUGIA
	db ICON_HO_OH       ; HO_OH
	db ICON_ARCANINE    ; KOMAITIFF
	db ICON_CELEBI      ; CELEBI
	db ICON_CELEBI      ; KOKOPELLI
	db ICON_GROWLITHE   ; PUPPERON
	...
	db ICON_PIDGEY      ; KIWACKI
	db ICON_PINECO      ; SILKANE
