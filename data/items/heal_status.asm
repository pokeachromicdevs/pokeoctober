...
StatusHealingActions:
	...
	dwbb AWAKENING,    PARTYMENUTEXT_HEAL_SLP, SLP
	...
	dwbb PSN_CURE_BERRY, PARTYMENUTEXT_HEAL_PSN, 1 << PSN
	dwbb PRZ_CURE_BERRY, PARTYMENUTEXT_HEAL_PAR, 1 << PAR
	dwbb BURNT_BERRY,  PARTYMENUTEXT_HEAL_FRZ, 1 << FRZ
	dwbb ICE_BERRY,    PARTYMENUTEXT_HEAL_BRN, 1 << BRN
	dwbb MINT_BERRY,   PARTYMENUTEXT_HEAL_SLP, SLP
	dwbb MIRACLE_BERRY, PARTYMENUTEXT_HEAL_ALL, %11111111
	dwbb -1, 0, 0 ; end
