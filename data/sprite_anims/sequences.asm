...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_GS_INTRO_BUBBLE,           SPRITE_ANIM_SEQ_GS_INTRO_BUBBLE,             SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_GS_INTRO_BUBBLE
	db SPRITE_ANIM_FRAMESET_GS_INTRO_SHELLDER,         SPRITE_ANIM_SEQ_GS_INTRO_SHELLDER,           SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_GS_INTRO_SHELLDER
	db SPRITE_ANIM_FRAMESET_GS_INTRO_MAGIKARP,         SPRITE_ANIM_SEQ_GS_INTRO_MAGIKARP,           SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_GS_INTRO_MAGIKARP
	db SPRITE_ANIM_FRAMESET_UNUSED_INTRO_AERODACTYL,   SPRITE_ANIM_SEQ_UNUSED_INTRO_AERODACTYL,     SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_UNUSED_INTRO_AERODACTYL
	db SPRITE_ANIM_FRAMESET_GS_INTRO_LAPRAS,           SPRITE_ANIM_SEQ_GS_INTRO_LAPRAS,             SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_GS_INTRO_LAPRAS
	db SPRITE_ANIM_FRAMESET_GS_INTRO_NOTE,             SPRITE_ANIM_SEQ_GS_INTRO_NOTE,               SPRITE_ANIM_DICT_GS_INTRO ; SPRITE_ANIM_INDEX_GS_INTRO_NOTE
	db SPRITE_ANIM_FRAMESET_CELEBI_LEFT,              SPRITE_ANIM_SEQ_NULL,                    $00 ; SPRITE_ANIM_INDEX_CELEBI
	db SPRITE_ANIM_FRAMESET_GS_INTRO_INVISIBLE_NOTE,   SPRITE_ANIM_SEQ_GS_INTRO_NOTE,               SPRITE_ANIM_DICT_GS_INTRO ; SPRITE_ANIM_INDEX_GS_INTRO_INVISIBLE_NOTE
	db SPRITE_ANIM_FRAMESET_GS_INTRO_JIGGLYPUFF,       SPRITE_ANIM_SEQ_GS_INTRO_JIGGLYPUFF,         SPRITE_ANIM_DICT_GS_INTRO ; SPRITE_ANIM_INDEX_GS_INTRO_JIGGLYPUFF
	db SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU,          SPRITE_ANIM_SEQ_GS_INTRO_PIKACHU,            SPRITE_ANIM_DICT_GS_INTRO ; SPRITE_ANIM_INDEX_GS_INTRO_PIKACHU
	db SPRITE_ANIM_FRAMESET_GS_INTRO_PIKACHU_TAIL,     SPRITE_ANIM_SEQ_GS_INTRO_PIKACHU_TAIL,       SPRITE_ANIM_DICT_GS_INTRO ; SPRITE_ANIM_INDEX_GS_INTRO_PIKACHU_TAIL
	db SPRITE_ANIM_FRAMESET_GS_INTRO_FIREBALL,         SPRITE_ANIM_SEQ_GS_INTRO_FIREBALL,           SPRITE_ANIM_DICT_GS_INTRO_2 ; SPRITE_ANIM_INDEX_GS_INTRO_FIREBALL
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CHIKORITA,        SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_TOTODILE, SPRITE_ANIM_DICT_GS_INTRO_2 ; SPRITE_ANIM_INDEX_GS_INTRO_CHIKORITA
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CYNDAQUIL,        SPRITE_ANIM_SEQ_GS_INTRO_CYNDAQUIL,          SPRITE_ANIM_DICT_GS_INTRO_2 ; SPRITE_ANIM_INDEX_GS_INTRO_CYNDAQUIL
	db SPRITE_ANIM_FRAMESET_GS_INTRO_TOTODILE,         SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_TOTODILE, SPRITE_ANIM_DICT_GS_INTRO_2 ; SPRITE_ANIM_INDEX_GS_INTRO_TOTODILE
	db SPRITE_ANIM_FRAMESET_GBC_SCREEN_FLAMES,         SPRITE_ANIM_SEQ_GBC_SCREEN_FLAMES,           $00 ; SPRITE_ANIM_INDEX_GBC_SCREEN_FLAMES
