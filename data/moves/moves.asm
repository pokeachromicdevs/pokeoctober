...
Moves1:
	...
	move EFFECT_TRI_ATTACK,         80, NORMAL,   100, 10,  30 ; TRI_ATTACK
	...
	move EFFECT_DEFENSE_DOWN_2,      0, NORMAL,    90, 10,   0 ; SCARY_FACE
	...
	move EFFECT_SPEED_DOWN_2_HIT,   20, ICE,      100, 10, 100 ; ICY_WIND
	...
	move EFFECT_MEAN_LOOK,           0, PSYCHIC,  100,  5,   0 ; MEAN_LOOK
	...
	move EFFECT_LEVEL_DAMAGE,        1, GROUND,   100, 20,   0 ; UPROOT
	move EFFECT_NORMAL_HIT,         70, FLYING,   100, 10,   0 ; WIND_RIDE
	move EFFECT_FLINCH_HIT,         90, ROCK,     100, 10,  30 ; ROCK_HEAD
	move EFFECT_ALWAYS_HIT,         80, WATER,    100, 15,  10 ; WATER_SPORT
	move EFFECT_ACCURACY_UP,         0, GRASS,    100, 15, 100 ; BRIGHT_MOSS
	move EFFECT_ATTACK_UP_HIT,      80, STEEL,     80, 10,  10 ; STRONG_ARM
	move EFFECT_NORMAL_HIT,         55, BUG,       95, 20,   0 ; CROSS_CUTTER
	move EFFECT_EVASION_DOWN,        0, NORMAL,   100, 20,   0 ; TEMPT
	...
	move EFFECT_NORMAL_HIT,         80, DRAGON,   100, 15,   0 ; DRAGON_SMASH
	move EFFECT_SHELL_BOMB,         70, STEEL,    100,  5, 100 ; SHELL_BOMB
	move EFFECT_NORMAL_HIT,         40, NORMAL,   100, 35,   0 ; MAGNETISM: TODO
