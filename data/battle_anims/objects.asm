...
; BATTLE_ANIM_OBJ_SAFARI_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SMALL_ROCK, BATTLE_ANIM_FUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_SAFARI_BAIT
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SAFARI_BAIT, BATTLE_ANIM_FUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_ROCKS
...
; BATTLE_ANIM_OBJ_MEGAPHONE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLE_ANIM_FRAMESET_MEGAPHONE_UNUSED, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_MISC
; BATTLE_ANIM_OBJ_CAKE
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLE_ANIM_FRAMESET_METRONOME_HAND, BATTLE_ANIM_FUNC_PRESENT_SMOKESCREEN, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_OBJECTS
...
; BATTLE_ANIM_OBJ_MAGNET_BOMB_SPINNING
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_MAGNET_BOMB, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_MAGNET_BOMB_IMPACT
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_MAGNET_BOMB, BATTLE_ANIM_FUNC_RADIAL_MOVE_IN, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_SMALL_EXPLOSION
	battleanimobj RELATIVE_X, $94, BATTLE_ANIM_FRAMESET_EXPLOSION_SMALL, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_SMALL_EXPLOSION
...
; ANIM_OBJ_HAIL
	battleanimobj RELATIVE_X | X_FLIP, $00, BATTLE_ANIM_FRAMESET_HAIL, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE


;; BATTLE_ANIM_OBJ_LAVA_PLUME_BURST_SMOKE
;	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLE_ANIM_FRAMESET_LAVA_BURST_SMOKE, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_SMOKE_PUFF_BIG
