...
; ANIM_OBJ_WATER_SPORT
	battleanimobj ABSOLUTE_X, $90, BATTLE_ANIM_FRAMESET_WATER_SPOUT_FALLING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_WATER
; ANIM_OBJ_WATER_SPOUT_RISING
	battleanimobj RELATIVE_X, $70, BATTLE_ANIM_FRAMESET_WATER_SPOUT_RISING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_WATER
; ANIM_OBJ_WATER_SPOUT_FALLING
	battleanimobj RELATIVE_X, $20, BATTLE_ANIM_FRAMESET_WATER_SPOUT_FALLING, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_WATER
