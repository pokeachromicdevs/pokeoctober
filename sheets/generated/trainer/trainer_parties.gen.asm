...
YoungsterGroup:
	...
	next_party ; Joey (Rematch3)
		...
		dbw 21, RATTATA
		dw TAILWHIP, QUICKATTACK, HYPERFANG, SCARYFACE
	end_party
	next_party ; Joey (Rematch4)
		db "JOEY@", TRAINERTYPE_MOVES
		dbw 30, RATTATA
		dw TAILWHIP, QUICKATTACK, HYPERFANG, PURSUIT
	end_party
	next_party ; Joey (Rematch5)
		db "JOEY@", TRAINERTYPE_MOVES
		dbw 37, RATTATA
		dw HYPERBEAM, QUICKATTACK, HYPERFANG, PURSUIT
	end_party
	next_party ; Mikey (1)
...
InstructorGroup:
	...
	next_party ; Stanley (Rematch5)
		...
		dbw 48, ALAKAZAM
		dw PSYCHIC, DYNAMICPUNCH, SHADOWBALL, KINESIS
		dbw 49, EXEGGUTOR
		dw PSYCHIC, EGGBOMB, SOLARBEAM, SUNNYDAY
		dbw 50, NOCTOWL
		dw FLY, TAKEDOWN, HYPNOSIS, DREAMEATER
	end_party
	next_party ; Curtis (1)
...
LassGroup:
	...
	next_party ; Ariel (1)
		...
		dbw 5, ZUBAT
		dw HAZE, LEECHLIFE, SUPERSONIC, NO_MOVE
		dbw 7, PIDGEY
		dw TACKLE, SANDATTACK, QUICKATTACK, NO_MOVE
		dbw 8, HOPPIP
		dw QUICKATTACK, SPLASH, TAILWHIP, NO_MOVE
	end_party
	next_party ; June (1)
	...
	next_party ; Tina (1)
		...
		dbw 10, BUTTERFREE
		dw TACKLE, STRINGSHOT, CONFUSION, GUST
	end_party
	end_party_list
...
SECTION "Trainer Class Leader Falkner", ROMX
LeaderFalknerGroup:
	next_party ; Falkner (1)
		db "FALKNER@", TRAINERTYPE_ITEMS | TRAINERTYPE_MOVES
		dbw 9, PIDGEY
		dw NO_ITEM
		dw MUDSLAP, QUICKATTACK, GUST, NO_MOVE
		dbw 11, NATU
		dw NO_ITEM
		dw PECK, NIGHTSHADE, NO_MOVE, NO_MOVE
		dbw 14, ADBARSTORK
		dw BERRY
		dw FURYATTACK, GROWL, WHIRLWIND, NO_MOVE
	end_party
	end_party_list
...
FisherGroup:
	...
	next_party ; Koi (1)
		...
		dbw 15, MAGIKARP
		dw SPLASH, WATERGUN, TACKLE, FLAIL
		dbw 15, MAGIKARP
...
LassNieNieGroup:
	...
	next_party ; Niechelle (5)
		...
		dbw 52, AMPHAROS
		dw THUNDERBOLT, ICEPUNCH, FIREPUNCH, IRONTAIL
		dbw 53, GESTICUTE
		dw RAZORLEAF, ICEBEAM, PURSUIT, GIGADRAIN
		dbw 54, JIGGLYPUFF
		dw BODYSLAM, RETURN, SWEETKISS, PROTECT
		dbw 55, GRANBULL
		dw CRUNCH, HYPERBEAM, PROTECT, SHADOWBALL
		dbw 56, PIPLUP
		dw SOLARBEAM, SWEETKISS, BUBBLEBEAM, PETALDANCE
		dbw 56, AUDINO
		dw SOLARBEAM, SWEETKISS, BUBBLEBEAM, PETALDANCE
	end_party
	end_party_list
...
SageGroup:
	...
	next_party ; Chow (1)
		...
		dbw 8, BELLSPROUT
		dw VINEWHIP, GROWTH, WRAP, NO_MOVE
		dbw 8, ABRA
		dw THUNDERWAVE, SWIFT, FLASH, FORESIGHT
		dbw 10, VULPIII
		dw EMBER, TAILWHIP, QUICKATTACK, NO_MOVE
	end_party
	next_party ; Edmond (1)
...
SECTION "Trainer Class Leader Whitney", ROMX
LeaderWhitneyGroup:
	next_party ; Whitney (1)
		db "WHITNEY@", TRAINERTYPE_ITEMS | TRAINERTYPE_MOVES
		dbw 17, KOALYPTUS
		dw NO_ITEM
		dw SCRATCH, GROWL, BITE, RAZORLEAF
		dbw 19, FARFETCH_D
		dw NO_ITEM
		dw GUST, SANDATTACK, FURYATTACK, MUDSLAP
		dbw 20, MILTANK
		dw PRZCUREBERRY
		dw ROLLOUT, ATTRACT, STOMP, MILKDRINK
	end_party
	end_party_list
...
TwinsGroup:
	next_party ; Mei & Lei 1 (1)
		db "MEI & LEI 1", TRAINERTYPE_NORMAL
		dbw 17, LEDYBA
		dbw 17, SPINARAK
		dbw 21, BUTTERFREE
		dbw 21, BEEDRILL
	end_party
	next_party ; Mei & Lei 2 (1)
		db "MEI & LEI 2", TRAINERTYPE_NORMAL
		dbw 21, BUTTERFREE
		dbw 21, BEEDRILL
		dbw 17, LEDYBA
		dbw 17, SPINARAK
...
SECTION "Trainer Class Leader Bugsy", ROMX
LeaderBugsyGroup:
	next_party ; Bugsy (1)
		db "BUGSY@", TRAINERTYPE_ITEMS | TRAINERTYPE_MOVES
		dbw 23, LEDIAN
		dw NO_ITEM
		dw TACKLE, SUPERSONIC, COMETPUNCH, ROLLOUT
		dbw 24, ARIADOS
		dw FIREMANE
		dw POISONSTING, BITE, SPIDERWEB, NIGHTSHADE
		dbw 26, HERACROSS
		dw SILVERPOWDER
		dw FURYCUTTER, DETECT, HORNATTACK, CROSSCUTTER
	end_party
	end_party_list
...
SECTION "Trainer Class Leader Morton", ROMX
LeaderMortonGroup:
	next_party ; Morton (1)
		db "MORTON@", TRAINERTYPE_ITEMS | TRAINERTYPE_MOVES
		dbw 29, RATTLIT
		dw NO_ITEM
		dw CONFUSION, ECHO, SHADOWBALL, RAPIDSPIN
		dbw 30, GIRAFARIG
		dw SPELLTAG
		dw LICK, PURSUIT, STOMP, HYPNOSIS
		dbw 32, FENNECURSE
		dw MIRACLEBERRY
		dw SHADOWBALL, FAINTATTACK, FLAMEWHEEL, WILLOWISP
	end_party
	end_party_list
