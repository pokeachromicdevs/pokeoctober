...
AdbarstorkFrontpic: INCBIN "gfx/pokemon/adbarstork/front.animated.2bpp.lz"
...
TonbossFrontpic: INCBIN "gfx/pokemon/tonboss/front.animated.2bpp.lz"
TonbossBackpic:  INCBIN "gfx/pokemon/tonboss/back.2bpp.lz"
MallodyFrontpic: INCBIN "gfx/pokemon/mallody/front.animated.2bpp.lz"
...
WorfursFrontpic: INCBIN "gfx/pokemon/worfurs/front.animated.2bpp.lz"
...
FennecurseFrontpic:	INCBIN "gfx/pokemon/fennecurse/front.animated.2bpp.lz"
FennecurseBackpic:	INCBIN "gfx/pokemon/fennecurse/back.2bpp.lz"
OrijoeyFrontpic:	INCBIN "gfx/pokemon/orijoey/front.animated.2bpp.lz"
