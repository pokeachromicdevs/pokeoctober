...
INCLUDE "data/items/tmhm_attributes.asm"
...
INCLUDE "engine/phone/scripts/stanley.asm"
...
INCLUDE "data/phone/text/stanley_caller.asm"
...
INCLUDE "data/phone/text/stanley_overworld.asm"
...
INCLUDE "data/phone/text/stanley_callee.asm"
