...
Music_RivalBattle_Ch1_loop_1:
	...
	intensity $82
	note F_, 2
	callchannel Music_RivalBattle_Ch1_branch_2
	note F_, 2
	callchannel Music_RivalBattle_Ch1_branch_2
	note G#, 2
	callchannel Music_RivalBattle_Ch1_branch_2
	...
	callchannel Music_RivalBattle_Ch1_branch_2
	note G_, 2
	callchannel Music_RivalBattle_Ch1_branch_3
	note G_, 2
	callchannel Music_RivalBattle_Ch1_branch_3
	note A#, 2
	callchannel Music_RivalBattle_Ch1_branch_3
	note G_, 2
	callchannel Music_RivalBattle_Ch1_branch_3
	loopchannel 2, Music_RivalBattle_Ch1_loop_1
	intensity $a3
	dutycycle 1
	octave 3
	note F_, 6
...
Music_RivalBattle_Ch1_branch_2:
	note C#, 2
	note D#, 2
	note C#, 2
	endchannel

Music_RivalBattle_Ch1_branch_3:
	note D#, 2
	note F_, 2
	note D#, 2
	endchannel
...
Music_RivalBattle_Ch2_loop:
	...
	note A#, 1
	note B_, 1
	callchannel Music_RivalBattle_Ch2_branch_2
	note D#, 4
	intensity $b7
	note G_, 4
	intensity $b3
	...
	note __, 2
	note C_, 4
	loopchannel 0, Music_RivalBattle_Ch2_loop
...
Music_RivalBattle_Ch2_branch_2:
	intensity $b3
	octave 4
	note C_, 2
	note C_, 4
...
Music_RivalBattle_Ch4:
	...
	note C_, 1
	note C_, 1
Music_RivalBattle_Ch4_loop:
	note D#, 2
	note D#, 2
	note C_, 2
	note D#, 2
	loopchannel 0, Music_RivalBattle_Ch4_loop
