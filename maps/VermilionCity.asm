...
VermilionCity_MapEvents:
	...
	db 10 ; warp events
	warp_event 18, 16, VERMILION_FISHING_SPEECH_HOUSE, 1
	warp_event  9, 15, VERMILION_POKECENTER_1F, 1
	warp_event  7, 23, POKEMON_FAN_CLUB, 1
	warp_event 39, 32, VERMILION_MAGNET_TRAIN_SPEECH_HOUSE, 1
	warp_event 19, 23, VERMILION_MART, 2
	warp_event 21, 17, VERMILION_DIGLETTS_CAVE_SPEECH_HOUSE, 1
	warp_event 10, 29, VERMILION_GYM, 1
	warp_event 36, 32, VERMILION_PORT_PASSAGE, 1
	warp_event 38, 34, VERMILION_PORT_PASSAGE, 2
	warp_event 36, 23, DIGLETTS_CAVE, 1

	db 0 ; coord events

	db 8 ; bg events
	bg_event 31,  6, BGEVENT_READ, VermilionCitySign
	bg_event  5, 29, BGEVENT_READ, VermilionGymSign
	bg_event  5, 23, BGEVENT_READ, PokemonFanClubSign
	bg_event 33, 23, BGEVENT_READ, VermilionCityDiglettsCaveSign
	bg_event 27, 15, BGEVENT_READ, VermilionCityPortSign
	bg_event 10, 15, BGEVENT_READ, VermilionCityPokecenterSign
	bg_event 20, 23, BGEVENT_READ, VermilionCityMartSign
	bg_event 37, 30, BGEVENT_ITEM, VermilionCityHiddenFullHeal
	...
	object_event 36, 25, SPRITE_BIG_SNORLAX, SPRITEMOVEDATA_BIGDOLLSYM, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VermilionSnorlax, EVENT_VERMILION_CITY_SNORLAX
	object_event 16, 10, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, VermilionGymBadgeGuy, -1
