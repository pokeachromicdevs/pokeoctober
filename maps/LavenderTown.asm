...
LavenderTown_MapEvents:
	...
	warp_event 14, 17, SOUL_HOUSE, 1
	warp_event 12, 17, LAV_RADIO_TOWER_1F, 1
	...
	bg_event 13, 17, BGEVENT_READ, VolunteerPokemonHouseSign
	bg_event 16, 17, BGEVENT_READ, SoulHouseSign
	...
	object_event 11, 13, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, LavenderTownTeacherScript, -1
	object_event 15, 17, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LavenderTownGrampsScript, -1
	object_event  1,  7, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 1, LavenderTownYoungsterScript, -1
