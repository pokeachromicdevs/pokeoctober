...
Route29_MapEvents:
	...
	db 1 ; warp events
	warp_event 36, 16, ROUTE_29_ROUTE_46_GATE, 3
	...
	db 2 ; bg events
	bg_event 57,  7, BGEVENT_READ, Route29Sign1
	...
	object_event 38,  2, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route29TeacherScript, -1
	...
	object_event 43, 10, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TuscanyScript, EVENT_ROUTE_29_TUSCANY_OF_TUESDAY
