...
.Elm
	variablesprite SPRITE_ROUTE33_KAREN_ELM, SPRITE_ELM
	;sjump .ManageSpriteAppears
...
; karen + kurt
	object_event 42, 10, SPRITE_ROUTE33_KAREN_ELM, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 1, ObjectEvent, EVENT_BEAT_ROUTE33_KAREN
