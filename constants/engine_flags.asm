...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_SHRINE ;??
	const ENGINE_FLYPOINT_ALDER
...
; wDailyPhoneTimeOfDayFlags
	...
	const ENGINE_STANLEY_TUESDAY_NIGHT
	...
	const ENGINE_NIECHELLE_SATURDAY_NIGHT
