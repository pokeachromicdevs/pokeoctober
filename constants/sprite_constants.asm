...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_FLEDGLING ; 65
	const SPRITE_BIRD_KEEPER ; 66
	const SPRITE_SOLDIER ; 67
	const SPRITE_FAT_GUY ; 68
	const SPRITE_SPORTSMAN ; 69
	const SPRITE_CAMPER ; 6a
	const SPRITE_HIKER ; 6b
	const SPRITE_GAMEBOY_GIRL ; 6c
	const SPRITE_MYSTIC ; 6d
	const SPRITE_MANCHILD ; 6e
	const SPRITE_SCHOOLBOY ; 6f
