...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_FLEDGLING ; 66
	const SPRITE_BIRD_KEEPER ; 67
	const SPRITE_SOLDIER ; 68
	const SPRITE_FAT_GUY ; 69
	const SPRITE_SPORTSMAN ; 70
	const SPRITE_CAMPER ; 71
	const SPRITE_HIKER ; 72
	const SPRITE_GAMEBOY_GIRL ;73
	const SPRITE_MYSTIC ;74
	const SPRITE_MANCHILD ;75
	const SPRITE_SCHOOLBOY ;76
	const SPRITE_ROCKCLIMBER ; 77
	const SPRITE_FOLLOWER ; 78
	const SPRITE_YANMEGA ; 79
...
SPRITE_VARS EQU const_value
	...
	const SPRITE_SILENTTOWN_RIVAL_DUDE ; f6
	const SPRITE_ROUTE33_KAREN_ELM_WILL ; f7
