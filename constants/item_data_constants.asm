...
; held item effects
	...
	const_def 80
	const HELD_NORMAL_WEAKEN
	const HELD_FIGHTING_WEAKEN
	const HELD_FLYING_WEAKEN
	const HELD_POISON_WEAKEN
	const HELD_GROUND_WEAKEN
	const HELD_ROCK_WEAKEN
	const HELD_BUG_WEAKEN
	const HELD_GHOST_WEAKEN
	const HELD_FIRE_WEAKEN
	const HELD_WATER_WEAKEN
	const HELD_GRASS_WEAKEN
	const HELD_ELECTRIC_WEAKEN
	const HELD_PSYCHIC_WEAKEN
	const HELD_ICE_WEAKEN
	const HELD_DRAGON_WEAKEN
	const HELD_DARK_WEAKEN
	const HELD_STEEL_WEAKEN
