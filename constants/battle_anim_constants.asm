; battle_anim_struct members (see macros/wram.asm)
	...
	const BATTLEANIMSTRUCT_FRAMESET_ID_LO
...
NUM_BATTLE_ANIM_STRUCTS EQU 10 ; see wActiveAnimObjects

BATTLEANIMSTRUCT_OAMFLAGS_FIX_COORDS_F EQU 0
...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_MAGNET_BOMB_SPINNING        ; ca
	const BATTLE_ANIM_OBJ_MAGNET_BOMB_IMPACT          ; cb
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_MAGNET_BOMB           ; c2
