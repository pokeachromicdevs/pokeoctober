...
; wCherrygroveCitySceneID
	...
	const SCENE_CHERRYGROVECITY_ALREADY_GUIDED ; 1
...
; wRoute33SceneID
	...
	const SCENE_ROUTE33_BATTLED_KURT ; 3
...
; wVioletGymSceneID
	const_def
	const SCENE_VIOLETGYM_NOTHING              ; 0
	const SCENE_VIOLETGYM_WHITNEY_STOPS_CRYING ; 1
...
; wVioletCitySceneID
	...
	const SCENE_VIOLETCITY_TALKED_TO_SAGE ; 1

; wSproutTower3FSceneID
	const_def 0
	const SCENE_SPROUT_TOWER_3F_NOTHING ; 0
	const SCENE_SPROUT_TOWER_3F_BATTLED_RIVAL ; 1
