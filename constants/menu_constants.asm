...
; ScrollingMenu items structure format
	...
	const SCROLLINGMENU_ITEMS_16_QUANTITY
...
; used by PokemonActionSubmenu (see engine/pokemon/mon_menu.asm)
	...
	const MONMENUITEM_WINDRIDE   ; 2
	const MONMENUITEM_WATERSPORT ; 3
	const MONMENUITEM_STRONGARM  ; 4
	const MONMENUITEM_BOUNCE     ; 5
	const MONMENUITEM_BRIGHTMOSS ; 6
